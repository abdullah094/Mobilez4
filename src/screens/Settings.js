import { StyleSheet, Text, View,Dimensions, SafeAreaView, ScrollView, TouchableOpacity, Alert } from 'react-native'
...
Alert.alert(response.data?.message)
  ...
  return (
    ...
    <View style={{height:150,width:width,backgroundColor:color.orange,alignItems:'flex-end',flexDirection:'row'}}>
    <SafeAreaView style={{margin:15}}>
      {/* <Image style={{width:50,height:50,borderRadius:25}} source={}/> */}
      <Text style={{color:color.white,fontSize:20,fontWeight:'600',}}>{_profile.first_name}</Text>
      <Text style={{color:color.white,fontSize:15,fontWeight:'600',}}>{_profile.email}</Text>
...
<TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('MyWishlist')}>
  <Text style={[styles.button_text]}>My Wishlist</Text>
</TouchableOpacity>
<TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('TermsAndCondition')}>
...
<>
 ...
 <Text style={[styles.button_text,{color:color.orange}]}>Login/Register</Text>
</TouchableOpacity>
<TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('ContactUs')}>
  <Text style={[styles.button_text]}>Contact Us</Text>
</TouchableOpacity>
