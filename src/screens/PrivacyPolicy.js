        ...
        <View
          ...
          <View>
            <Text
              ...
              Privacy Policy We may handle your data in connection with your use
              of the Platform. This privacy notice together with our Terms and
              Conditions set out, for the Platform, our collection and sharing
              practices, the uses to which personal data is put, how we protect
              it following the data protection laws, and your privacy rights.
            ...
            <View>
              <Text style={styles.bulletPoint}>
                ...
                Mobilez Market websites that reference or link to this Statement
              ...
              <Text style={styles.bulletPoint}>
                • We collect some information directly from you for example, via
                forms you complete or products or Services you access, download,
                or otherwise obtain. Such information is generally limited to:
              ...
              <Text style={styles.bulletPoint}>
                • Other information is received indirectly from you via the use
                of the Services for example, from observing your actions on the
                Website or providing you with account access.
              </Text>
            </View>
          </View>
          <View
            ...
            <Text
              ...
              Information regarding usage of the Services or Website via weblogs
              is collected automatically and passively using various
            ...
            <Text
              ...
              vendors, data suppliers, service providers, commercially available
              marketing lists or registries, telephone directories, social
              networks (such as LinkedIn), news outlets, and related media. Such
              Personal Data collected via these sources is limited to business
              contact information, such as names, contact information, job
              titles, IP addresses, and LinkedIn and other social media
              profiles.
            </Text>
          </View>
          <View
            ...
            <Text
              ...
              have a legitimate business interest to process such Personal Data;
              it is necessary to comply with applicable laws or regulations; we
              have your consent where required under applicable law to use your
              information where we rely on your consent, you have the right to
              withdraw consent by contacting us as set forth below.
            </Text>
          </View>
          <View
            style={{
          ...
          <View>
            ...
            <Text style={styles.bulletPoint}>
              ...
              us about you. This right will only apply where for example: we no
              longer need to use the personal data to achieve the purpose we
              collected it for, where you withdraw your consent if we are using
              your data based on your consent; or where you object to the way we
              process your data in line with Right 6 below.
            </Text>
            <Text style={styles.bulletPoint}>
              • Right 4 – A right to restrict our processing of personal data
              held by us about you. This right will only apply where for
              example: you dispute the accuracy of the personal data held by us;
              where you would have the right to require us to erase the personal
              data but would prefer that our processing is restricted instead;
              or where we no longer need to use the personal data to achieve the
              purpose we collected it for, but you require the data for dealing
              with legal claims
            </Text>
            <Text style={styles.bulletPoint}>
              • Right 5 – A right to receive personal data, which you have
              provided to us, in a structured, commonly used, and
              machine-readable format. You also have the right to require us to
              transfer this personal data to another organization, at your
              request.
            </Text>
            <Text style={styles.bulletPoint}>
            ...
            <Text style={styles.bulletPoint}>
              • Right 7 – A right to withdraw your consent, where we are relying
              on it to use your data for example, to provide you with
            ...
            <View
              ...
              <Text
                ...
                ability to deliver relevant services to you. We will use
                reasonable endeavors to ensure that your data is accurate. To
                assist us with this, you should notify us of any changes to your
                data by updating your profile on the Platform (App) or by
            ...
            <View
              ...
              <Text
                ...
                We may change the content of the Platform and how we use cookies
                and consequently, this privacy notice and our cookies notice,
                and any other document to which they refer are subject to change
                at any time. If we make material updates to this privacy notice,
                we will update the date it was last changed and will indicate it
                in the document. Any changes we make to this privacy notice
                become effective immediately when we post the revised privacy
                notice on the Platform. We recommend that you review this
