...
const renderItem = ({item,index}) => (
    <TouchableOpacity onPress={()=>navigation.navigate('SignUp',{city:item.city})} style={{width:width,height:50,justifyContent:'flex-end',paddingHorizontal:20,borderBottomWidth:1,borderColor:'white',padding:5}}>
<Text>{item.city}</Text>
    </TouchableOpacity>
)
  return (
